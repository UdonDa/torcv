...
def conv3x3(inplanes, outplanes, stride=1, padding=1, dilation=1):
...
# When you use drn in DeepLabV3+, you should set BatchNorm=SynchronizedBatchNorm2d.
def drn_a_resnet50(BatchNorm=nn.BatchNorm2d, pretrained=True):
